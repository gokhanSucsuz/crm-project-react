...
const LiElements = () => {
    ...
    const { active, setActive, leads, notes, handleRemove, handleEdit } = useContext(CRMContext)
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="btn-group" role="group">
                                                ...
                                                <button onClick={() => handleEdit(lead.id)} type="button" className="btn btn-warning">Edit</button>
